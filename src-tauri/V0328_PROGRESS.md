# v0.3.28 — 🎉 已发布 (2026-06-02)

**已发布**:内容-only(复用 v0.3.26 exe)。补丁 v0.3.27→v0.3.28=234.4MB,tag+3资产(portable 1248.8MB)+commit 2e49c6d+latest=v0.3.28+链 preflight 通过。下次基准=干净 pf2-wiki-offline_0.3.28_x64-portable。
